...
public class Network extends Thread {
	...
	// static means it is all shared accross the thread
     ...
     * @param cip
     */
     public synchronized void setClientIP(String cip)
     { 
         clientIP = cip;
     }
     ...
     * @param sip
     */
     public synchronized void setServerIP(String sip)
     { 
         serverIP = sip;
     }
     ...
     * @param
     */
     public synchronized String getClientConnectionStatus()
     {
         return clientConnectionStatus;
     }
     ...
     * @param connectStatus
     */
     public synchronized void setClientConnectionStatus(String connectStatus)
     { 
     ...
     * @param
     */
     public synchronized String getServerConnectionStatus()
     {
         return serverConnectionStatus;
     }
     ...
     * @param connectStatus
     */
     public synchronized void setServerConnectionStatus(String connectStatus)
     { 
     ...
     * @param
     */
     public synchronized int getPortID()
     {
         return portID;
     }
     ...
     * @param pid
     */
     public synchronized void setPortID(int pid)
     { 
         portID = pid;
     }
     ...
     * @param
     */
     public synchronized String getInBufferStatus()
     {
         return inBufferStatus;
     }
     ...
     * @param inBufStatus
     */
     public synchronized void setInBufferStatus(String inBufStatus)
     { 
     ...
     * @param
     */
     public synchronized String getOutBufferStatus()
     {
         return outBufferStatus;
     }
     ...
     * @param outBufStatus
     */
     public synchronized void setOutBufferStatus(String outBufStatus)
     { 
     ...
     * @param
     */
     public synchronized String getNetworkStatus()
     {
         return networkStatus;
     }
     ...
     * @param netStatus
     */
     public synchronized void setNetworkStatus(String netStatus)
     { 
     ...
     * @param
     */
     public synchronized int getinputIndexClient()
     {
         return inputIndexClient;
     }
     ...
     * @param i1
     */
     public synchronized void setinputIndexClient(int i1)
     { 
         inputIndexClient = i1;
     }
     ...
     * @param
     */
     public synchronized int getinputIndexServer()
     {
         return inputIndexServer;
     }
     ...
     * @param i2
     */
     public synchronized void setinputIndexServer(int i2)
     { 
         inputIndexServer = i2;
     }     
     ...
     * @param
     */
     public synchronized int getoutputIndexServer()
     {
         return outputIndexServer;
     }
     ...
     * @param o1
     */
     public synchronized void setoutputIndexServer(int o1)
     { 
     ...
     * @param
     */
     public synchronized int getoutputIndexClient()
     {
         return outputIndexClient;
     }
     ...
     * @param o2
     */
     public synchronized void setoutputIndexClient(int o2)
     { 
	 ...
	 * @param
	 */
	 public synchronized int getMaxNbPackets()
	 {
	     return maxNbPackets;
	 }
     ...
     * @param maxPackets
     */
     public synchronized void setMaxNbPackets(int maxPackets)
     { 
