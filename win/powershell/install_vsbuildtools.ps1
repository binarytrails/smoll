...
while (!(Test-Path "C:/BuildTools/VC/Tools/MSVC/14.27.29110/bin/Hostx64/x64/cl.exe")){ echo "Waiting for vs_buildtools to complete for a valid cl.exe compiler... Sleeping..."; Start-Sleep 60 }
